...
public final class TwoDeadWheelLocalizer implements Localizer {
    ...
    public static class Params {
        public double parYTicks = -8995.556742931902; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -9722.68630969728; // x position of the perpendicular encoder (in tick units)
    }
}
